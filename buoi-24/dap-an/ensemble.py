...
CUA_SO_CHON = [95, 113]     # W1, W2: dùng để chọn mô hình / ước lượng trọng số
CUA_SO_BAO_CAO = [131]      # W3: chỉ dùng để báo cáo, chưa từng dùng để chọn
...
def chon_va_bao_cao(diem: pd.DataFrame, theo_chuoi: bool = True,
    ...
    rồi báo cáo MASE của lựa chọn đó trên cua_so_bao_cao. Hai nhóm cửa sổ phải tách rời: báo cáo sau chọn."""
    assert not set(cua_so_chon) & set(cua_so_bao_cao) and max(cua_so_chon) < min(cua_so_bao_cao)
