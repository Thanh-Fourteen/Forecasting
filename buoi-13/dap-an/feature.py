...
#
# Bản ĐÃ SỬA. Dữ liệu: doanh số bán lẻ (UCI Online Retail II), lượt xem vi.wikipedia,
...
def feature_tre(y: pd.Series, tam: int = TAM, cac_lag=(1, 2, 3, 7, 14, 28),
    ...
    tre = y.shift(tam)  # tất cả tính từ chuỗi đã lùi `tam` bước
    for lag in cac_lag:
