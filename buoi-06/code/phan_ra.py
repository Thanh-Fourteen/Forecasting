...
#
# Dữ liệu: EIA-930, nhu cầu điện theo giờ của PJM Interconnection năm 2024.
...
def phan_ra(y: pd.Series, robust: bool = False) -> pd.DataFrame:
    """Phân rã cổ điển (cộng) với chu kỳ ngày. Cột: y, trend, seasonal_24, resid."""
    kq = seasonal_decompose(y, model="additive", period=CHU_KY)
    return pd.DataFrame({"y": y, "trend": kq.trend, "resid": kq.resid, "seasonal_24": kq.seasonal})
