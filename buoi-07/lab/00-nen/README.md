...
|---|---|---|
| `bea-nipa-quy` | Public domain (U.S. government) | https://apps.bea.gov/national/Release/TXT/ |
...
| `uci-bike-sharing` | CC BY 4.0 | https://archive.ics.uci.edu/dataset/275/bike+sharing+dataset |
