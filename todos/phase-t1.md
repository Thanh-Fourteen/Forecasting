...
Bổ sung (2026-09-21, yêu cầu người dùng "tóm tắt cần có biểu đồ minh hoạ"):
- Quy ước đổi: tóm tắt **có hình** (trước đây cấm). Dùng lại hình đã có trong `hinh/`, đặt vào thẻ nó minh hoạ, mỗi
  hình một dòng **Đọc hình** là câu kết luận trong `tai-lieu.md`; không vẽ hình mới, không lấy hình mục Lab.
- Đã chèn: buổi 1 — 5 hình (mot-duong, sai-so-ao, mot-tuan, tong-tuan, chi-phi-bat-doi-xung); buổi 2 — 5 hình
  (histogram-tich-luy, ham-mat-mat, tuong-quan, hoan-vi, bootstrap-do-dai-khoi); buổi 3 — 3 hình (truc-thoi-gian,
  dst-hai-ngay, gio-nong-nhat; bỏ bam-gio vì là hình của Lab).
- PDF in lại bằng WeasyPrint trên máy Linux (thay 3 bản in bằng Chrome headless): 9, 12, 9 trang.
