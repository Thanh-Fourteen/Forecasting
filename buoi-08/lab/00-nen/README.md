...
| `open-meteo-dallas-2024` | CC BY 4.0 | https://open-meteo.com/en/docs/historical-weather-api |
| `open-meteo-houston-2024` | CC BY 4.0 | https://open-meteo.com/en/docs/historical-weather-api |
